...
const prefix = "!"
const developers = "742736678841614399"
...
setInterval(() => {
    http.get(`http://bot-reo12.glitch.me/`); /// حط اسم المشروع تبعك name تعديل مهم بدل
}, 280000);
...
client.login("NzQ1NjUzMTIyMjUyNDA2OTU1.Xz05lQ.rBXX7RoRPosMfsc2kPSboVzl_Wg");
